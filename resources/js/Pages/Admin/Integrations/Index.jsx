...
const SETUP_GUIDES = {
    onesignal: {
        ...
        steps: [
            ...
            'Enable the integration here, then sign in as a Super Admin and allow browser notifications.',
            'Use Test to validate the OneSignal App ID and API key. It does not send a notification to an administrator.',
        ],
    ...
    meta_app: {
        ...
        sections: [
            ...
            },
            {
                ...
                steps2: [
                    'Submit your app for App Review for any permissions marked as "Advanced Access" (pages_manage_posts, instagram_content_publish, and instagram_manage_comments).',
    ...
    oauth_google_mail: {
        ...
        steps: [
            ...
            'Create an OAuth client with application type Web application. Add the exact Callback URL shown on the integration edit page as an Authorized redirect URI. This server-side flow does not need an Authorized JavaScript origin.',
            'Before publishing, test with an allowlisted mailbox. Save the Client ID and Client Secret, enable the integration, and connect a Gmail mailbox from Client → Email Setup.',
