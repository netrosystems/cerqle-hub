...
- **Coexistence pilot (2026-09-09)**: When enabled for the workspace, the drawer offers Cloud API only or Keep WhatsApp Business app. The latter requires a country-coded number, expandable limitations and acknowledgement. Prepare and Continue with Meta are separate steps; history/contact import is explicitly off. Phone cards and inbox bubbles identify Business app connections and messages without inventing an agent identity.
