...
class SocialPost extends Model
{
    ...
    protected $fillable = ['workspace_id', 'title', 'body', 'media_urls', 'youtube_options', 'platform_payloads', 'temporary_media_released_at', 'target_accounts', 'status', 'scheduled_at', 'timezone', 'published_at', 'provider_post_id', 'post_url', 'publish_results', 'ai_generated', 'ai_prompt'];
    ...
    protected function casts(): array
    {
        return [
            ...
            'platform_payloads' => 'array',
            'temporary_media_released_at' => 'datetime',
