...
Route::middleware(['web', 'client-app'])->prefix('app/inbox')->name('client.inbox.')->group(function () {
    ...
    Route::patch('/chat-widgets/{chatWidget}/sdk-enabled', [ChatWidgetController::class, 'toggleSdkEnabled'])->name('chat-widgets.sdk-enabled');
    ...
    Route::post('/setup/{channelAccount}/repair', [InboxSetupController::class, 'repairMetaConnection'])
        ->middleware(['client.access:write', 'throttle:20,1'])
        ->name('setup.repair');
