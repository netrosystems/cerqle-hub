...
class IntegrationConfig extends Model
{
    ...
    public const LABELS = [
        ...
        'oauth_google_mail' => 'Google Gmail OAuth',
    ...
    public const FIELDS = [
        ...
        'oauth_google_mail' => [
            ['key' => 'client_id', 'label' => 'OAuth Client ID', 'type' => 'text', 'required' => true, 'hint' => 'Google Cloud Console → APIs & Services → Credentials → OAuth 2.0 Client ID (Web application).'],
